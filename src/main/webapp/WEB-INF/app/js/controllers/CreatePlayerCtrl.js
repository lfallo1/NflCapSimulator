(function() {
	angular.module('app.controllers').controller('CreatePlayerCtrl', ['$rootScope', '$scope', '$location', '$routeParams', '$modal', 'ContractResource',
			'TransactionResource', 'RosterActionResource',
			'PositionResource', 'TeamResource',
			'MinimumSalaryResource', 'ArrayServices', 'GenericValidator', 'SalaryValidator', 'TransactionResource', 'MessageServices',
	function($rootScope, $scope, $location, $routeParams, $modal, ContractResource,
	        ...
	        $scope.openErrorModal = function () {
	            var modalInstance = $modal.open({
	                templateUrl: 'app/views/modals/errorSubmittingFormTemplate.html',
