...
public class ContractStatusDao {
    ...
    public List<ContractStatus> getAll() {
        return this.jdbcTemplate.query("SELECT * FROM " + ContractStatus.class.getAnnotation(TableName.class).value(), new GenericObjectMapper<ContractStatus>(ContractStatus.class));
    }
}
